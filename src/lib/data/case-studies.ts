...
export const caseStudies: CaseStudy[] = [
  {
    ...
    publicUrl: "https://www.blockdocsqr.co.uk/",
    challenge:
    ...
    technologies: [
      ...
      "Email notifications",
      "Print-ready PDF/PNG QR exports",
    ],
    outcome:
  ...
  },
  {
    ...
    publicUrl: "https://www.vettique.com/",
    challenge:
    ...
    technologies: [
      ...
      "Proceed / Caution / Do Not Wire verdict",
  ...
  },
  {
    ...
    technologies: [
      ...
      "Document and credential uploads",
      "DBS checks workflow",
